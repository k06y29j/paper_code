...
EXP="$ROOT/MY-V2/jscc-f/cnn-work"
...
SPEC="$EXP/configs/accepted_qmix_top3_v9_ema.json"
INIT="$ARTIFACT_ROOT/checkpoints-continuous-q/cnn-continuous-q-d512-hardp05-v9/continuous_q_receiver_best.pth"
