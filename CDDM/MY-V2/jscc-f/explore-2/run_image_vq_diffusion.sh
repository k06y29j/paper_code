...
SCRIPT="$ROOT/MY-V2/jscc-f/explore-2/train_image_vq_diffusion.py"
GPU="${GPU:-0}"
ORACLE_CHECKPOINT="${ORACLE_CHECKPOINT:?set ORACLE_CHECKPOINT to an image-vq oracle}"
VERSION="${VERSION:-image-vq-diffusion-v1}"
LOG_DIR="$ROOT/MY-V2/jscc-f/explore-2/logs-image-diffusion"
SAVE_DIR="$ROOT/MY-V2/jscc-f/explore-2/checkpoints-image-diffusion"
